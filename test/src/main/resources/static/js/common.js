    ...
    $.getJSON('http://digitalnow.co.kr/reserve/pensionInfo/'+ account +'/4',	//User Info
        function(data){
            ...
            $("footer").append(
                ...
                '<div class="InBox">' +
                '<ul>' +
                '<li><a href="about.html">솔스파 </a></li>' +
                '<li><a href="rooms.html?num=01">객실안내</a></li>' +
                '<li><a href="special.html?num=01">특별함</a></li>' +
                ...
                '<div id="ft-cont">' +
                '<div class="InBox">' +
                '<h5><a href="index.html"><img src="images/ft_logo.jpg" width="109" height="200" alt="" /></a></h5>' +
                '<ul class="address">' +
                '<li>예약문의<span>'+ USER_TEL1 +'</span></li>' +
                '<li><span>'+ NEW_USER_ADDR + '<br>('+ USER_ADDR +')</span></li>' +
                '<li>' +
                '<ul class="sns">' +
                ...
                '<p>' +
                '업체명 :' + BUSI_NM +  '<br />' +
                '주소 : '+ NEW_USER_ADDR +'('+ USER_ADDR +')<br />' +
                '사업자번호: <span class="BUSI_NO"></span><br />' +
                '통신판매업 번호 : '+ COMM_SALE_NO +'<br />' +
                // ' / Email : '+ USER_EMAIL  +'<br />' +
                '</p>' +
                '<p><a href="http://gonylab.com" target="_blank">홈페이지 제작 | GONYLAB</a></p>' +
                '</div>' +
                '</div>'
            );
